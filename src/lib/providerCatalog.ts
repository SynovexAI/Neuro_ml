...
export const PROVIDER_CATALOG: Record<string, ProviderPreset> = {
  ...
  github:     { label: "GitHub Models (preview — often unavailable)", baseUrl: "https://models.inference.ai.azure.com", free: true, embeddings: true, keyHint: "preview: Azure host needs a CLASSIC ghp_ token (fine-grained github_pat_ → 401); the new host is often unreachable. Prefer Groq/Cerebras/Mistral." },
  ...
  jina:       { label: "Jina AI (embeddings)",     baseUrl: "https://api.jina.ai/v1",                            free: true,  embeddings: true,  keyHint: "jina.ai · 1M free tokens, no card — EMBEDDINGS ONLY (type jina-embeddings-v3)" },
