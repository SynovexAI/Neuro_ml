  ...
  async function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      if (f.size > MAX_UPLOAD_BYTES) {
        throw new Error(`Upload rejected: ${formatBytes(f.size)} exceeds the 50 MB upload limit.`);
      }
      if (/\.(csv|tsv)$/i.test(f.name)) {
        ...
        throw new Error("Unsupported dataset format. Please upload CSV or TSV files.");
      }
      ...
      {step === "data" && (
        <div className="card">
          ...
          <div className="card-b">
            ...
            {dataTab === "upload" && (<div>
              <div className="dropzone" onClick={() => fileRef.current?.click()}>Click to upload a <b>CSV</b> or <b>TSV</b> file (parsed &amp; trained locally)</div>
